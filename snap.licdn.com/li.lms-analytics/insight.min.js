...
TagSettings=function(){function d(a){var c;this.context=a;this.data={};this.cookie_manager=new CookieManager(this.context);this._set_window_options();this._set_cookie_options();a=this.data.custom_group_id;c=this.data.custom_user_id;if(a!=null&&c!=null)this.data.custom_tracking_id=""+a+"="+c;this.data.protocol="index.html";this.data.page_url=this.context.win.location.href;this.data.hostname=this.context.win.location.hostname;this.data.referrer=this.context.doc.referrer;this.data.loaded_in_iframe=window.self!==
...
CookieManager=function(){function d(a){this.context=a;this.one_day=864E5}d.prototype.get=function(a){var c,b,e,f,g;g=this.context.doc.cookie.split("; ");e=0;for(f=g.length;e<f;e++){c=g[e];b=c.split("=");c=b[0];b=b[1];if(c===a&&b!=null)return unescape(b)}return null};d.prototype.set=function(a,c,b,e){if(b==null)b=1;if(e==null)e="index.html";b="expires="+this.context.clock.future_date(this.one_day*b).toGMTString();return this.context.doc.cookie=""+a+"="+escape(c)+"; "+b+"; path="+e};d.prototype["delete"]=function(a,
c){if(c==null)c="index.html";return this.set(a,"",-10,c)};return d}();var StatsCounter,__bind=function(d,a){return function(){return d.apply(a,arguments)}};
...
a.split("=");a=f[0];f=f[1];if(a!=null&&f!=null&&c[a]==null){this.params["np."+e+".id"]=a;this.params["np."+e+".time"]=f;c[a]=true;e+=1}}return this.stats_counter.clear_stats()}};d.prototype.add_secure_param_if_page_is_secure=function(){if(this.tag_settings.data.protocol==="index.html")return this.params.s="1"};d.prototype.overwrite_url_param_if_needed=function(){var a;a=this.tag_settings.data.custom_channel_id;if(a!=null){this.add("url",a);return this.add("is_channel","1")}else if(this.tag_settings.data.loaded_in_iframe)return this.add("url",
...
f.length;b<e;b++){a=f[b];c=a[0];a=a[1];if(a===true){ErrorLog.log(this.context,{error:c},PixelLogger,ConsoleLogger,LocalLogger);return c}}this.write_tags_to_dom();return true};return d}();dom_ready(function(){var d;d=new Context(document,window,new Clock);try{PixelLogger.set_pixel_path("http://www.clarityhk.com/insight_tags/error.gif");return InsightTags.init(d)}catch(a){return ErrorLog.log(d,{error:a,pid:window._bizo_data_partner_id},PixelLogger,ConsoleLogger,LocalLogger)}});var BizoCallback;
